        ...
        <div class="row">
            ...
            <div class="breadcrumbs">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Изменить сотрудника</li>
                </ol>
            </div>
            ...
            <div class="col-md-5 col-sm-offset-4 asp">
                <div class="login-form labaa">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <input type = "text" name = "name" value = "<?=$pers['name']?>">
...
<label>Краткая информация</label>
                        <textarea rows = "10" name="descript"><?=$pers['description']?></textarea><br><br>

                        <label>Фото сотрудника</label>
                        <img src = "<?=Personal::getImageActor($pers['pers_id'])?>" width = 250 height = 250>
                        <input type="file" name="pers_img" placeholder="" value="">
