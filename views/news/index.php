						...
						<div class="col-sm-9">
							...
							<div class="mainmenu pull-left">
								<ul class="nav navbar-nav collapse navbar-collapse">
									...
									<li><a href="#" class = "active men" style="font-weight:700;font-size:20px;">Новости</a></li> 
        ...
        <div class="col-sm-9">
					<div class="blog-post-area">
						...
						<div class="single-blog-post">
							<h3 class = "title_news"><?php echo $n['name'];?></h3>
							<div class="post-meta">
								<ul>
									<li><i class="fa fa-clock-o"></i><?php echo $n['time'];?></li>
									<li><i class="fa fa-calendar"></i><?php echo $n['date'];?></li>
								</ul>
							</div>
							<p><?php echo mb_substr($n['text'],0,250);?>...</p>
							<a  class="btn btn-primary" href="/newsingle/<?php echo $n['id'];?>">Читать</a>
						</div><hr class = "hrrh">
                        <?php endforeach;?>
