						...
						<div class="col-sm-9">
							...
							<div class="mainmenu pull-left">
								<ul class="nav navbar-nav collapse navbar-collapse">
									...
									<li><a href="/truppa" class = "active men" style="font-weight:700;font-size:20px;">Коллектив</a></li>
								</ul>
							</div>
						</div>
					</div>
...
<section>
			<div class="container">
                ...
                <div class="col-sm-9 padding-right">
                    ...
                    <h2 class="title_reps text-center">Коллектив театра</h2>
                    <?php foreach($p as $sp):?>
                        <a href="/pers/<?php echo $sp['id'];?>"><div class="col-sm-4">
                            <div class="product-image-wrapper_reps">
                                <div class="single-products_reps">
                                    <div class="productinfo_reps text-center">
                                        <img src="<?=Personal::getImageActor($sp['id'])?>" alt=""/>
                                        <h2><?=$sp['name']?></h2>
