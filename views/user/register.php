    ...
    <div class="container">
		...
		<?php if ($result): ?>
                    <div class="jumbotron jumbotron-fluid">
											<div class="container">
												<h5 class="display-4 ban">Вы успешно зарегистрированы! Теперь вы можете <a href = "/user/login">авторизоваться</a> на сайте.</h5>
											</div>
										</div>
                <?php else: ?>
            <div class="col-sm-4 col-sm-offset-4">
                    <div class="login-form"><!--sign up form-->
                                ...
                                <form action="#"method = "post">
                                    <input type="email" name = "email" placeholder="Email" vlaue = "<?php echo $email?>"/>
                                    <input type="phone" name = "phone" placeholder="Номер телефона" value = "<?=$phone?>"/>
                                    ...
                                    <button type="submit" name = "submit" class="btn btn-default logbtn">Регистрация</button>
                                </form>
								<div class = "assda">Уже есть аккаунт? - <a href = "/user/login">Авторизуйтесь!</a></div>
                                </div><!--/sign up form-->
